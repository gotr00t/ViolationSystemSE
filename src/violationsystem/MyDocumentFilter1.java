...
public class MyDocumentFilter1 extends DocumentFilter {
    ...
    public void insertString(DocumentFilter.FilterBypass fp, int offset, String stringToFilter, AttributeSet aset)
        ...
        if (Character.isDigit(stringToFilter.charAt(len - 1)) || Character.isWhitespace(stringToFilter.charAt(len - 1)) || Character.isISOControl(stringToFilter.charAt(len - 1))) {
